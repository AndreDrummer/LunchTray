...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewModelGetCurrencyValueOfViewModelAccompanimentPrice = null;
        ...
        java.lang.String viewModelGetCurrencyValueOfViewModelSidePrice = null;
        ...
        java.lang.String viewModelGetCurrencyValueOfViewModelEntreePrice = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x181L) != 0) {
                    ...
                    if (viewModel != null) {
                        // read viewModel.getCurrencyValueOf(viewModel.accompaniment.getValue().price)
                        viewModelGetCurrencyValueOfViewModelAccompanimentPrice = viewModel.getCurrencyValueOf(viewModelAccompanimentPrice);
                    }
            }
            ...
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    if (viewModel != null) {
                        // read viewModel.getCurrencyValueOf(viewModel.entree.getValue().price)
                        viewModelGetCurrencyValueOfViewModelEntreePrice = viewModel.getCurrencyValueOf(viewModelEntreePrice);
                    }
            }
            ...
            if ((dirtyFlags & 0x190L) != 0) {
                    ...
                    if (viewModel != null) {
                        // read viewModel.getCurrencyValueOf(viewModel.side.getValue().price)
                        viewModelGetCurrencyValueOfViewModelSidePrice = viewModel.getCurrencyValueOf(viewModelSidePrice);
                    }
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            this.accompanimentPrice.setText(viewModelGetCurrencyValueOfViewModelAccompanimentPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            this.entreePrice.setText(viewModelGetCurrencyValueOfViewModelEntreePrice);
            this.entreeSelection.setText(viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            this.sidePrice.setText(viewModelGetCurrencyValueOfViewModelSidePrice);
